package stdio.lilith.processors.toOperationStateMapper
...
import stdio.lilith.visitors.ToOperationStateMapperKClassVisitor

class ToOperationStateMapperProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        if (operationStatePackage == null) {
            ...
            symbols.firstOrNull()?.accept(
                ToOperationStateMapperKClassVisitor(codeGenerator, dependencies),
                Unit
            )
        }
